  ...
  return (
    <div className="metric-card-glass flex flex-col gap-4 p-5 rounded-[18px]" data-testid="gasto-campanas">
      ...
      <div className="flex items-start justify-between">
        ...
        <span className="px-2.5 py-1 rounded-full bg-green-100 dark:bg-green-500/15 text-green-700 dark:text-green-400 text-[12px] font-bold border border-green-200 dark:border-green-500/25 shrink-0">
          -33%
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-[11px] text-[#5580a8] dark:text-white/40">Distribución por canal — 2025</p>
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-[11px] text-[#5580a8] dark:text-white/40">total</span>
            </div>
          </div>
            ...
            {CANALES.map((c) => (
              <div key={c.name} className="flex items-center justify-between">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[11px] text-[#5580a8] dark:text-white/50">{c.name}</span>
                </div>
                <span className="text-[11px] font-semibold text-[#0c1f3f] dark:text-white">
        ...
        <div className="flex flex-col gap-3">
          <p className="text-[11px] text-[#5580a8] dark:text-white/40">Proyección con segmentación</p>

          <div className="flex flex-col gap-2">
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-[12px] text-[#5580a8] dark:text-white/50">Actual</span>
                <span className="text-[12px] font-bold text-[#0c1f3f] dark:text-white">$2.4M</span>
              </div>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-[12px] text-[#5580a8] dark:text-white/50">Optimizada</span>
                <span className="text-[12px] font-bold text-green-600 dark:text-green-400">$1.6M</span>
              </div>
              <div className="h-2 rounded-full bg-[rgba(180,210,240,0.20)] dark:bg-white/[0.06] overflow-hidden">
          ...
          <div className="mt-auto rounded-[12px] bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/25 px-3 py-2.5">
            <p className="text-[11px] font-semibold text-green-700 dark:text-green-400">Ahorro total proyectado</p>
            <p className="font-display text-[22px] font-extrabold text-green-700 dark:text-green-400 leading-tight">$2.8M</p>
          </div>
        </div>
      </div>
    </div>
